            ...
            <div class="container-fluid">
				<div class='panel panel-default'>
          			<div class='panel-heading'>
          				<h3 class="panel-title" ><i class='icon-dashboard icon-large'></i> 仪表盘</h3>
          			</div>
                <!-- Page Heading -->
                ...
                <div class="row">
                    ...
                    <div class='panel panel-default'>
                        ...
                        <h4 class="panel-title">
                            <i class='icon-dashboard icon-middle'></i> 统计预览
                        </h4>
                       	</div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-primary">
                            ...
                            <a href="${pageContext.request.contextPath}/manage.do?flag=usermanage">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-green">
                            ...
                            <a href="${pageContext.request.contextPath}/manage.do?flag=bookmanage">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                        ...
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">${total_records}</div>
                                        <div>总借阅数</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">${total_notbacks }</div>
                                        <div>未归还图书数</div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> 最近一周每日借阅次数</h3>
                            </div>
                            <div class="panel-body">
                                <div id="day-borrows"></div>
                            </div>
                        </div>
                    </div>
                </div>
