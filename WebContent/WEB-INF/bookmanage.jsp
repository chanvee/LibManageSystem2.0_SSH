                    			...
                    			<div class='panel panel-default'>
                       			...
                       			<div class="panel-body">
							          ...
							          <ul class='pagination pagination-sm'>
							          	<c:if test="${pageNow != 1}">
							          	<li>
							          	 <a href="${pageContext.request.contextPath}/manage.do?flag=bookmanage&pageNow=${pageNow-1}">&laquo;</a>
							          	</li>
							          	</c:if>
							          	<c:if test="${pageNow == 1}">
							          	<li class="disabled">
							          	...
							          	<c:if test="${i  != pageNow}">
							          		<li>
							            	<a href="${pageContext.request.contextPath}/manage.do?flag=bookmanage&pageNow=${i }">${i }</a>
							    			</li>
							    		</c:if>
							    		<c:if test="${i  == pageNow}">
							          		<li class="active">
							    		...
							    		<li>
							          	 <a href="${pageContext.request.contextPath}/manage.do?flag=bookmanage&pageNow=${pageNow+1}">&raquo;</a>
							          	</li> 
							          	</c:if>
							          	<c:if test="${pageNow == pageCount}">
							    		<li class="disabled">
