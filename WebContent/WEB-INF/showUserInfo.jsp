                    			...
                    			<div class='panel panel-default'>
                    				<div class='panel-heading'>
                        				<h4 class="panel-title">
                            				<i class='icon-search icon-middle'></i> 用户详细信息
                        				</h4>
                       				</div>
                       			...
                       			<div class="panel-body">
                       				<div class='col-md-12'>
			                            ...
			                            <ul class='pagination pagination-sm'>
							          	<c:if test="${pageNow != 1}">
							          	<li>
							          	 <a href="${pageContext.request.contextPath}/user.do?flag=showUserRecord&username=${user_info.name }&pageNow=${pageNow-1}">&laquo;</a>
							          	</li>
							          	</c:if>
							          	<c:if test="${pageNow == 1}">
							          	<li class="disabled">
							          	...
							          	<c:if test="${i  != pageNow}">
							          		<li>
							            	<a href="${pageContext.request.contextPath}/user.do?flag=showUserRecord&username=${user_info.name }&pageNow=${i }">${i }</a>
							    			</li>
							    		</c:if>
							    		<c:if test="${i  == pageNow}">
							          		<li class="active">
							    		...
							    		<li>
							          	 <a href="${pageContext.request.contextPath}/user.do?flag=showUserRecord&username=${user_info.name }&pageNow=${pageNow+1}">&raquo;</a>
							          	</li> 
							          	</c:if>
							          	<c:if test="${pageNow == pageCount}">
							    		<li class="disabled">
