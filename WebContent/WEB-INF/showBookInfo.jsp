                       			...
                       			<div class="panel-body">
                       				<div class='col-md-8 text-center'>
                       					<table class="table table-bordered table-hover">
			                                ...
			                                <tbody>
			                                <c:forEach items="${booklist_info}" var="book_info">   
			                                	<tr align="center">
			                                        <td>${book_info.id}</td>
                       	...
                       	<div class="row">
                    		<div class="col-lg-12">
                    			<div class='panel panel-default'>
                    				<div class='panel-heading'>
                        				<h4 class="panel-title">
                            				<i class='icon-search icon-middle'></i> 图书借阅信息
                        				</h4>
                       				</div>
                       			...
                       			<div class="panel-body">
                       				<div class='col-md-12'>
			                            ...
			                            <ul class='pagination pagination-sm'>
							          	<c:if test="${pageNow != 1}">
							          	<li>
							          	 <a href="${pageContext.request.contextPath}/book.do?flag=showBookRecord&bookname=${finded_bookname }&pageNow=${pageNow-1}">&laquo;</a>
							          	</li>
							          	</c:if>
							          	<c:if test="${pageNow == 1}">
							          	<li class="disabled">
							          	...
							          	<c:if test="${i  != pageNow}">
							          		<li>
							            	<a href="${pageContext.request.contextPath}/book.do?flag=showBookRecord&bookname=${finded_bookname}&pageNow=${i }">${i }</a>
							    			</li>
							    		</c:if>
							    		<c:if test="${i  == pageNow}">
							          		<li class="active">
							    		...
							    		<li>
							          	 <a href="${pageContext.request.contextPath}/book.do?flag=showBookRecord&bookname=${finded_bookname}&pageNow=${pageNow+1}">&raquo;</a>
							          	</li> 
							          	</c:if>
							          	<c:if test="${pageNow == pageCount}">
							    		<li class="disabled">
